...
setwd('D:/Internship/Modeling-eLife')
...
fit <- stan(file = 'fitting_scripts/Normal_Model/JG_stan_withdecay_sepBetas_noLambda_nodecay_noRescaling.stan', data = standata, seed=seed, iter = 1, chains = 1)
...
save.image(file = "stanfits_jonny_output_s1_Feb10_2020_noLambda_noDecay.RData", version = NULL, ascii = FALSE)
#
