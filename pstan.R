...
fit <- stan(file = 'stan_fitting_scripts/JG_stan_sepAlphas_r-qt1_oneLambda_noPerseverance_noDecay_noRescaling_init0.5.stan', data = standata, seed=seed, iter = 1, chains = 1)
...
save.image(file = "stan_fits/JG_s2_sepAlphas_sepStages_r-qt1_NoStickiness_noDecay_init0.5_May11_2020.RData", version = NULL, ascii = FALSE)
