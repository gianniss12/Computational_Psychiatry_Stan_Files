...
fit <- stan(file = 'fitting_scripts/stan_allparams_sepAlphas_noLambda_noDecay_jonny.stan', data = standata, seed=seed, iter = 1, chains = 1)
...
# Windows
fit_2 = pstan(fit=fit, seed = sample.int(.Machine$integer.max, 1), data = standata, iter=100, chains = 4, refresh = 1)

save.image(file = "fittings/stanfits_jonny_output_s2_Feb22_2020_noDecay.RData", version = NULL, ascii = FALSE)
#
